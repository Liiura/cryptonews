    ...
    <Col className="coin-detail-container">
      <Col className="coin-heading-container">
        <Title level={2} className="coin-name">
          {data?.data?.coin.name} ({millify(data?.data?.coin?.price)}) Price
        </Title>
      ...
      <Col className='coin-links'>
        <Title level={3} className = "coin-details-heading">See the exchanges of this coin</Title>
        <Link to={`/exchanges/${coinId}`}><p className='exchange-footer-title'>Exchanges</p> </Link>
      </Col>
    </Col>
  );
};
